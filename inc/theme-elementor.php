 ...
 */
if ( ! function_exists( 'nicex_unfiltered_files_upload' ) ) {
	function nicex_unfiltered_files_upload() {
...
add_action( 'elementor/init', 'nicex_unfiltered_files_upload' );

/**
 * Nicex Widgets Priority
 */
...
add_action( 'elementor/element/section/section_typo/after_section_end', function( $section, $args ) {
	...
	$section->start_controls_section(
		'section_navbar_offset', [
			'label' => esc_html__( 'Navbar Offset', 'nicex' ),
	...
	$section->add_control(
		'navbar_offset_padding', [
			'label' => esc_html__( 'Navbar Offset (With Padding)', 'nicex' ),
			'type' => Elementor\Controls_Manager::SWITCHER,
...
add_action( 'elementor/element/section/section_typo/after_section_end', function( $section, $args ) {
	...
	$section->start_controls_section(
		'section_vertical_lines', [
			'label' => esc_html__( 'Vertical Lines', 'nicex' ),
			'tab' => \Elementor\Controls_Manager::TAB_STYLE,
		]
	);
	...
	$section->add_control(
		'lines_z_index', [
			'label' => esc_html__( 'Z-Index', 'nicex' ),
...
add_action( 'elementor/init', function() {
	require_once NICEX_REQUIRE_DIRECTORY . 'inc/elementor/column.php';
} );