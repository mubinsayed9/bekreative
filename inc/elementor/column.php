...
class MS_Element_Column extends Module {
	...
	public function register_controls( Controls_Stack $element, $section_id ) {
		...
		$element->add_control(
			'_sticky-column', [
				'label' => esc_html__( 'Sticky Column', 'nicex' ),
		...
		$element->add_control(
			'_stretch', [
				'label' => esc_html__( 'Stretch', 'nicex' ),
				'type' => Elementor\Controls_Manager::SWITCHER,
		...
		$element->add_control(
			'_stretch_side', [
				'label' => esc_html__( 'Side', 'nicex' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'to-left',
				'options' => [
					'to-left' => esc_html__( 'Left', 'nicex' ),
					'to-right' => esc_html__( 'Right', 'nicex' )
				],
				'prefix_class' => '',
				'condition' => [
		...
		$element->add_control(
			'_stretch_reset_mobile', [
				'label' => esc_html__( 'Reset Mobile', 'nicex' ),
				'type' => Elementor\Controls_Manager::SWITCHER,
		...
		$element->add_responsive_control(
			'_column_min_width', [
				'label' => esc_html__( 'Min Width', 'nicex' ),
